    ...
    return (
      <footer className="footer">
        <div className="container">
          <ul className="footer__social-networks text-right">
            <li className="social-network">
              <a className="social-network__link text-center" href="mailto:vincentnavetat@gmail.com">
            ...
            <li className="social-network">
              <a className="social-network__link text-center" href="https://linkedin.com/in/vincentnavetat/" target="_blank">
            ...
            <li className="social-network">
              <a className="social-network__link text-center" href="https://behance.com/vincentnavetat/" target="_blank">
            ...
            <li className="social-network">
              <a className="social-network__link text-center" href="https://dribbble.com/vincentnavetat/" target="_blank">
            ...
            <li className="social-network">
              <a className="social-network__link text-center" href="https://twitter.com/vincentnavetat/" target="_blank">
            ...
            <li className="social-network">
              <a className="social-network__link text-center" href="https://instagram.com/vincentnavetat/" target="_blank">
            ...
            <li className="social-network">
              <a className="social-network__link text-center" href="https://github.com/vincentnavetat" target="_blank">
